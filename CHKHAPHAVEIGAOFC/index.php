...
<head>
    ...
    <title>ABIZZ|ALLBINS|CC - GG</title>
        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-body text-center">
              <h4 class="title mb-2">HAPHA VEIGA OFC</h4>
  ...
  $(document).ready(function() {
   ...
   // getSaldo();
    ...
    $('.btn-play').click(function() {
      ...
      if (!lista) {
        Swal.fire({
          title: 'Erro: Lista Vazia!', icon: 'error', showConfirmButton: false, toast: true, position: 'top-end', timer: 1000
        });
        return false;
      }

      Swal.fire({
        title: 'Teste Iniciado!', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 1000
      });
...
*/
      ...
      if (total > 10000) {
        Swal.fire({
          title: 'Limite de 10K de Linhas Exedido!', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 1000
        });
        return false;
      }
      ...
      line.forEach(function(data) {
        var callBack = $.ajax({
          ...
          success: function(retorno) {
            ...
            if (testadas == total) {
              Swal.fire({
                title: 'Teste Finalizado!', icon: 'success', showConfirmButton: false, toast: true, position: 'top-end', timer: 1000
              });
        ...
        $('.btn-stop').click(function() {
          Swal.fire({
            title: 'Teste Parado!', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 1000
          });
          $('.btn-play').attr('disabled', false);
          $('.btn-stop').attr('disabled', true);
          callBack.abort();
